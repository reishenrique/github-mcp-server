...
import { registerPullRequestReviewStrategyResource } from './resources/pull-request-review-strategy.resource.js';
...
async function startMcpServer() {
  ...
  registerPullRequestReviewStrategyResource(server);
